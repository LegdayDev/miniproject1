...
<div class="container mt-3">
	...
	<form action="/action_page.php">
		...
		<div class="flex">
			<div>
				<form method="get" action="form-action.html">
					<img class="card-img-top"
						src="https://dummyimage.com/150x200/adb5bd/495057" alt="..." />
			...
			<div>
				이름 : <input id="" type="text"></br> 이메일 : <input id=""
					type="text"></br> 학력 : <input id="" type="text"></br>
				<div>
					<form method="get" action="form-action.html">
						<p>스킬</p>
